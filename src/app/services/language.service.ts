                ...
                en: {
                    translation: {
                        ...
                        aboutMe: {
                            ...
                            p3: 'Working in the textile industry since 2021 has greatly influenced my organization skills, as it involves managing diverse inputs daily - such as color, size, material and textile types. This experience has equipped me with the systematic approach necessary for handling complex projects.',
                        },
                        skills: {
                            header: 'My skills',
                ...
                de: {
                    translation: {
                        ...
                        aboutMe: {
                            ...
                            p3: 'Seit 2021 bin ich in der Textilindustrie tätig, was meine Organisationsfähigkeit maßgeblich beeinflusst hat. In dieser Branche steht das Managen von diversen Inputs an der Tagesordnung  - dazu gehören beispielsweise Farbe, Größe, Material und Textiltyp. Diese Erfahrung hat mir eine systematische Herangehensweise vermittelt, welche für die Bewältigung von komplexen Projekten notwendig ist.',
                        },
                        skills: {
                            header: 'Meine Skills',
                        ...
                        contact: {
                            ...
                            p3: 'Frontend Entwickler gesucht?',
